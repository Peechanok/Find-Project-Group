...
urlpatterns = [
 ...
 path('view_course/',views.viewCourse, name='view_course') ,
  ...
  path('view_pro_ex/<int:student_id>/',views.view_pro_ex, name='view_pro_ex') ,
  path('remove_project_ex/<int:student_id>/<int:pro_id>/',views.removepro_ex, name='find_project_remove_pro_ex') ,
   path('view_project_ex/<int:student_id>/',views.viewpro_ex, name='find_project_view_pro_ex') ,
